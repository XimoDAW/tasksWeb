...
export class TaskDetailComponent {
  ...
  ngOnInit() {
    ...
    this.taskService.getTaskById(this.id).subscribe(response => {
      ...
      let indexIdManagement3 = dato.indexOf(':', indexIdManagement2 + 1)
      let indexIdManagement4 = dato.indexOf(':', indexIdManagement3 + 1)
      let indexIdManagement5 = dato.indexOf(':', indexIdManagement4 + 1)
      let indexStartDate1 = dato.indexOf(':', indexIdManagement5 + 1)
